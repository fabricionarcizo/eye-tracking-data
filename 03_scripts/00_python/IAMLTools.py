...
#<!-- File       : Ex403_homography.py                                      -->
#<!-- Description: Script to apply transformations between two planes using -->
#<!--            : homography                                               -->
...
#<!-- Date       : 12/02/2018                                               -->
#<!-- Change     : 12/02/2018 - Creation of this script                     -->
#<!-- Review     : 12/02/2018 - Finalized                                   -->
#<!--------------------------------------------------------------------------->
