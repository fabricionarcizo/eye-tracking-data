...
# Input CSV files.
files = [ "../../02_real/02_data_analysis/00_interpolate/00_original/*.csv",
...
outputs = [ "../../02_real/03_final_results/01_real_00_interpolate_00_original.csv",
            "../../02_real/03_final_results/01_real_00_interpolate_01_camera.csv",
            "../../02_real/03_final_results/01_real_00_interpolate_02_distortion.csv",
            "../../02_real/03_final_results/01_real_01_homography_00_original.csv",
            "../../02_real/03_final_results/01_real_01_homography_01_camera.csv",
            "../../02_real/03_final_results/01_real_01_homography_02_distortion.csv" ]

stats = [ "../../02_real/03_final_results/01_real_00_interpolate_00_original_sts.csv",
          "../../02_real/03_final_results/01_real_00_interpolate_01_camera_sts.csv",
          "../../02_real/03_final_results/01_real_00_interpolate_02_distortion_sts.csv",
          "../../02_real/03_final_results/01_real_01_homography_00_original_sts.csv",
          "../../02_real/03_final_results/01_real_01_homography_01_camera_sts.csv",
          "../../02_real/03_final_results/01_real_01_homography_02_distortion_sts.csv" ]
...
for i, path in enumerate(files):
    ...
    for csv in csvs:
        ...
        error = data.error_deg_x.values
        std = error.std()
        mean = error.mean()
        indices = np.where((error >= -3 * std + mean) & (error <= 3 * std + mean))
        errorX.append(error[indices])
    errorX = np.concatenate(errorX)

    # Remove outliers.
    std = errorX.std()
    mean = errorX.mean()
    indices = np.where((errorX >= -3 * std + mean) & (errorX <= 3 * std + mean))
    errorX = errorX[indices]
